...
public class Test_In_Firefox extends Baseclass
{
	WebDriver dr;
	  ...
	  {
		     dr=launch("firefox","https://demo.opencart.com/");//Launches the URL in the specified browser
	  ...
	  public void a_Invalid_Registration(String firstName,String lastName,String email,String telephone,String password,String confirmPassword) 
	  {
		  ...
		  s.screenShot("RegistrationFirefox["+i+"]");//takes screenshot by it's specified name
		  i++;
	  ...
	  public void b_Adding_Product_To_Cart(String firstName,String lastName,String email,String telephone,String password,String confirmPassword) 
	  {
		  ...
		  s.screenShot("AddingProductFirefox["+j+"]");//Takes the screenshot of the addedd product
		  j++;
	  ...
	  public void c_Adding_And_Removing_Products_From_Cart(String firstName,String lastName,String email,String telephone,String password,String confirmPassword) 
	  {
		  ...
		  s.screenShot("Before_Removing_ProductFirefox["+n+"]");//takes the screenshot of the added products
		  n++;
		  ...
		  s.screenShot("After_Removing_ProductFirefox["+m+"]");//takes the screenshot after product one product is removed
		  m++;
	  ...
	  public String[][] dataProvider1() 
	  {
		  ...
		  s=e.readRows("firefox",1,3);//reads the data from specified rows in the excel file
		  return s;
	  }
	  ...
	  {
		  String[][] s=new String[3][6];
		  s=e.readRows("firefox",4, 6);//reads the data from specified rows in the excel file
		  return s;
	  }
	  ...
	  {
		  String[][] s=new String[3][6];
		  s=e.readRows("firefox",7, 9);//reads the data from specified rows in the excel file
		  return s;
	  }
